...
function Profile() {
  ...
  const { deleteData: profileDeleteData, loading: profileDeletLoading } =
  ...
  useEffect(() => {
    if (profileUpdateData !== null) {
      ...
      setUpdateMessage({
        msg: 'Nao foi possivel atualizar seu perfil!',
        type: 'error',
      })
    }
    clearMessage()
                  ...
                  <>
                    ...
                    <FormComponent
                      ...
                      buttons={[
                        ...
                        {
                          className: 'alert',
                          disabled: profileDeletLoading,
                          id: 'delete-profile',
                          type: 'button',
                          onClick: handleDelete,
                          children: profileDeletLoading
                            ? 'aguarde..'
                            : 'excluir minha conta',
                        },
                      ]}
